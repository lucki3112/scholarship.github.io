...
<div class="container">
    ...
    @if ($student->state_verification=="Verified")
        <button type="button" class="btn btn-primary">{{$student->state_verification}}</button>
    @else
    <a href="{{route('state_verify',$student->id)}}" class="btn btn-success">Verify</a>    
    @endif
</div>
@endsection